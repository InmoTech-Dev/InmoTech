      ...
      >
        ...
        <div className="space-y-3 px-5 py-4">
          <div className="rounded-xl border border-slate-200 bg-slate-50 p-4">
            <p className="text-xs font-semibold uppercase tracking-wide text-slate-500">Periodo del contrato</p>
          ...
          <label
            className={`block rounded-xl border p-3 transition-colors ${
              rent.applyExtension ? "border-violet-300 bg-violet-50" : "border-violet-200 bg-violet-50/60"
            }`}
          >
        ...
        <div className="flex items-center justify-end gap-3 border-t border-slate-100 bg-slate-50 px-5 py-4">
          ...
          <button
            ...
            className="rounded-xl bg-violet-600 px-4 py-2 text-sm font-semibold text-white hover:bg-violet-700 disabled:cursor-not-allowed disabled:bg-slate-400"
          >
