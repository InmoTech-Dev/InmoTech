...
export const ActionButtons = ({ onView, onEdit, onDocument, onToggleFeatured, isFeatured, isFeaturedDisabled = false }) => {
  return (
    <div className="flex items-center gap-1.5 whitespace-nowrap">
      ...
      <button
        onClick={onEdit}
        className="p-1.5 text-gray-600 hover:text-green-600 hover:bg-green-50 rounded-lg transition-all group relative"
      >
