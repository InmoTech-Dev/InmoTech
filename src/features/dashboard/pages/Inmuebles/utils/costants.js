export const COMODIDADES_POR_TIPO = {
  Casa: ['Habitaciones', 'Baños', 'Parqueaderos', 'Balcon', 'Cuarto util', 'Cocina'],
  Apartamento: ['Habitaciones', 'Baños', 'Parqueaderos', 'Balcon', 'Cuarto util', 'Cocina'],
  Apartaestudio: ['Habitaciones', 'Baños', 'Parqueaderos', 'Balcon', 'Cuarto util', 'Cocina'],
  ...
  Oficina: ['Baños', 'Parqueaderos', 'Recepcion', 'Sala de juntas', 'Cocina', 'Aire acondicionado', 'Internet']
};
