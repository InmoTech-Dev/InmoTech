...
const AdminFilterBar = ({
    ...
    return (
        <div className="bg-white/80 backdrop-blur-md border-b border-slate-100 py-1.5 px-3 sticky top-0 z-20">
            <div className="flex flex-wrap items-center gap-3">
                <div className="flex items-center gap-2 mr-2">
                    <Filter className="w-4 h-4 text-indigo-500" />
                    <span className="text-[10px] font-bold text-slate-500 uppercase tracking-[0.15em] opacity-80">Filtrar por:</span>
                </div>
                ...
                <div className="flex-1 min-w-[140px] relative group">
                    ...
                    <select
                        ...
                        className="w-full bg-slate-50 border border-slate-100 rounded-xl pl-9 pr-8 py-2 text-[11px] font-semibold text-slate-600 appearance-none focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all cursor-pointer hover:bg-white hover:shadow-sm"
                    >
