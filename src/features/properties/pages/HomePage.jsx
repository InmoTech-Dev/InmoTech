  ...
  return (
    <main className="flex min-h-screen flex-col bg-transparent">
      ...
      <section className="relative h-[970px] overflow-hidden">
        ...
        />
        <div
          className="absolute inset-0 to-transparent flex flex-col items-start justify-center px-8 md:px-16 lg:px-24"
        ...
        <div className="container mx-auto px-4">
          <div className="rounded-xl shadow-2xl overflow-hidden">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-0">
              <div
                className={`stat-card bg-gradient-to-br from-[#00457B] to-[#005da3] text-white p-8 flex items-center space-x-6 transform transition-all duration-1000 hover:scale-105 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
              ...
              <div
                className={`stat-card bg-gradient-to-br from-[#005da3] to-[#0075cc] text-white p-8 flex items-center space-x-6 transform transition-all duration-1000 hover:scale-105 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm font-medium text-blue-100 leading-tight">
                    Compromiso legal garantizado
                  </div>
                </div>
              </div>

              <div
                className={`stat-card bg-gradient-to-br from-[#0075cc] to-[#008df5] text-white p-8 flex items-center space-x-6 transform transition-all duration-1000 hover:scale-105 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
              ...
              >
                ...
                <div>
                  <div className="text-xl font-bold mb-1 leading-none">
                    Compromiso
                  </div>
                  <div className="text-sm font-medium text-blue-100 leading-tight">
                    Con cada cliente
              ...
              <div
                className={`stat-card bg-gradient-to-br from-[#008df5] to-[#00a5ff] text-white p-8 flex items-center space-x-6 transform transition-all duration-1000 hover:scale-105 ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
      ...
      <section
        ref={categoriesRef}
        className={`py-16 transition-all duration-1000 ${categoriesVisible ? "opacity-100 scale-100" : "opacity-0 scale-95"}`}
      >
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {categories.map((category, index) => (
              <Link to={category.link} key={index}>
                <div
                  className={`group relative h-80 rounded-xl overflow-hidden shadow-xl transition-all duration-300 hover:shadow-2xl transform ${categoriesVisible ? "translate-x-0 opacity-100 scale-100" : "-translate-x-16 opacity-0 scale-95"}`}
      ...
      <section
        ref={servicesRef}
        className="py-20 bg-gray-50 transition-all duration-1000 ease-in-out transform"
        style={{
          opacity: servicesVisible ? 1 : 0,
          scale: servicesVisible ? 1 : 0.95,
        }}
      >
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto mt-6">
              Ofrecemos una amplia gama de servicios inmobiliarios para
            ...
            <CarouselContent>
              {services.map((service, index) => (
                <CarouselItem
                  key={index}
                  index={index}
                  className={`md:basis-1/2 lg:basis-1/3 p-3 transform transition-all duration-1000 ${servicesVisible ? "translate-y-0 opacity-100 scale-100" : "translate-y-8 opacity-0 scale-95"}`}
                  style={{ transitionDelay: `${index * 0.2}s` }}
                >
                  <Card className="h-full border-none shadow-xl hover:shadow-2xl transition-all duration-300 overflow-hidden group hover:scale-105">
                    <CardHeader className="pb-2 pt-6">
                      ...
                      <CardTitle className="text-2xl text-[#00457B]">
                        {service.title}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
      ...
      <section
        ref={featuredRef}
        className={`py-20 transition-all duration-1000 ${featuredVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"}`}
      >
        <div className="container mx-auto px-4">
      ...
      <section ref={whyChooseUsRef} className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div
              className={`relative h-[500px] rounded-xl overflow-hidden shadow-2xl order-2 md:order-1 transform transition-all duration-1000 ${whyChooseUsVisible ? "translate-x-0 opacity-100 scale-100" : "translate-x-12 opacity-0 scale-95"}`}
            ...
            <div className="order-1 md:order-2">
              <h2
                className={`text-3xl font-bold text-[#00457B] mb-6 relative inline-block transform transition-all duration-1000 ${whyChooseUsVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
                style={{ transitionDelay: "0s" }}
              >
                ¿Por qué elegirnos?
                <span className="absolute -bottom-2 left-0 w-20 h-1 bg-[#00457B]"></span>
              ...
              <p
                className={`text-gray-600 mb-10 mt-6 text-lg transform transition-all duration-1000 ${whyChooseUsVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
                style={{ transitionDelay: "0.2s" }}
              >
                En Matriz Inmobiliaria nos destacamos por ofrecer un servicio
                personalizado y de calidad, respaldado por años de experiencia
              ...
              <div className="space-y-8">
                {whyChooseUs.map((item, index) => (
                  ...
                  >
                    ...
                    <div>
                      <h3 className="font-bold text-xl mb-2 text-[#00457B]">
                        {item.title}
                      </h3>
              ...
              <Button
                asChild
                className={`mt-10 bg-[#00457B] text-white hover:bg-[#003b69] rounded-full px-8 py-6 h-auto text-lg font-medium shadow-lg transform transition-all duration-1000 ${whyChooseUsVisible ? "translate-y-0 opacity-100" : "translate-y-8 opacity-0"}`}
...
const services = [
  ...
  },
  {
    ...
    description:
      "Asesoramiento legal en todas las etapas de la transacción inmobiliaria para tu tranquilidad.",
...
const whyChooseUs = [
  ...
  },
  {
    ...
    description:
      "Atención individualizada adaptada a tus necesidades específicas y preferencias.",
    icon: <Star className="h-7 w-7 text-[#00457B]" />,
  },
  {
    title: "Amplia Cartera de Propiedades",
    description:
      "Acceso a cientos de propiedades exclusivas que se ajustan a todos los presupuestos y requisitos.",
